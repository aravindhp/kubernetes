...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.NodeLogQueryOptions)(nil), (*core.NodeLogQueryOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_NodeLogQueryOptions_To_core_NodeLogQueryOptions(a.(*v1.NodeLogQueryOptions), b.(*core.NodeLogQueryOptions), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.NodeLogQueryOptions)(nil), (*v1.NodeLogQueryOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_NodeLogQueryOptions_To_v1_NodeLogQueryOptions(a.(*core.NodeLogQueryOptions), b.(*v1.NodeLogQueryOptions), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*url.Values)(nil), (*v1.NodeLogQueryOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_url_Values_To_v1_NodeLogQueryOptions(a.(*url.Values), b.(*v1.NodeLogQueryOptions), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_NodeLogQueryOptions_To_core_NodeLogQueryOptions(in *v1.NodeLogQueryOptions, out *core.NodeLogQueryOptions, s conversion.Scope) error {
	...
	out.Boot = (*int64)(unsafe.Pointer(in.Boot))
	out.Query = *(*[]string)(unsafe.Pointer(&in.Query))
	return nil
}

// Convert_v1_NodeLogQueryOptions_To_core_NodeLogQueryOptions is an autogenerated conversion function.
func Convert_v1_NodeLogQueryOptions_To_core_NodeLogQueryOptions(in *v1.NodeLogQueryOptions, out *core.NodeLogQueryOptions, s conversion.Scope) error {
	return autoConvert_v1_NodeLogQueryOptions_To_core_NodeLogQueryOptions(in, out, s)
}

func autoConvert_core_NodeLogQueryOptions_To_v1_NodeLogQueryOptions(in *core.NodeLogQueryOptions, out *v1.NodeLogQueryOptions, s conversion.Scope) error {
	out.SinceTime = (*metav1.Time)(unsafe.Pointer(in.SinceTime))
	out.UntilTime = (*metav1.Time)(unsafe.Pointer(in.UntilTime))
	out.TailLines = (*int64)(unsafe.Pointer(in.TailLines))
	out.Pattern = in.Pattern
...
// Convert_core_NodeLogQueryOptions_To_v1_NodeLogQueryOptions is an autogenerated conversion function.
func Convert_core_NodeLogQueryOptions_To_v1_NodeLogQueryOptions(in *core.NodeLogQueryOptions, out *v1.NodeLogQueryOptions, s conversion.Scope) error {
	return autoConvert_core_NodeLogQueryOptions_To_v1_NodeLogQueryOptions(in, out, s)
}

func autoConvert_url_Values_To_v1_NodeLogQueryOptions(in *url.Values, out *v1.NodeLogQueryOptions, s conversion.Scope) error {
	...
	if values, ok := map[string][]string(*in)["untilTime"]; ok && len(values) > 0 {
		if err := metav1.Convert_Slice_string_To_Pointer_v1_Time(&values, &out.UntilTime, s); err != nil {
			return err
		}
	} else {
		out.UntilTime = nil
	...
	if values, ok := map[string][]string(*in)["pattern"]; ok && len(values) > 0 {
		if err := runtime.Convert_Slice_string_To_string(&values, &out.Pattern, s); err != nil {
			return err
		}
	} else {
		out.Pattern = ""
	}
	if values, ok := map[string][]string(*in)["boot"]; ok && len(values) > 0 {
		if err := runtime.Convert_Slice_string_To_Pointer_int64(&values, &out.Boot, s); err != nil {
			return err
		}
	} else {
		out.Boot = nil
	}
	if values, ok := map[string][]string(*in)["query"]; ok && len(values) > 0 {
		out.Query = *(*[]string)(unsafe.Pointer(&values))
	} else {
		out.Query = nil
	}
	return nil
...
// Convert_url_Values_To_v1_NodeLogQueryOptions is an autogenerated conversion function.
func Convert_url_Values_To_v1_NodeLogQueryOptions(in *url.Values, out *v1.NodeLogQueryOptions, s conversion.Scope) error {
	return autoConvert_url_Values_To_v1_NodeLogQueryOptions(in, out, s)
}
